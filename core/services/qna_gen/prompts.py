...

{
    "mcqs": [
        {
        "q": "An object starts from rest and accelerates uniformly at 2 m/s² for 5 seconds. How far does it travel in this time?",
        "c": ["10 m", "25 m", "50 m", "75 m"],
        "a": "25 m"
        },
        {
        "q": "A car moving with a velocity of 20 m/s is uniformly decelerated at a rate of 4 m/s² until it comes to a stop. How far does the car travel during this deceleration?",
        "c": ["50 m", "25 m", "75 m", "100 m"],
        "a": "50 m"
        }
    ]
}
